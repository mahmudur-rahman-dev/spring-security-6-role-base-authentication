package global.digital.signage.payload.response.generic;
...
@NoArgsConstructor
@ToString
public class DigitalSignageResponse<T> {
    private T data;
    ...
    public DigitalSignageResponse(T data) {
        this.data = data;
        validationCheck(data);
    }

    public DigitalSignageResponse(T data, String message) {
        this.data = data;
        this.message = message;
        validationCheck(data);
    }

    public DigitalSignageResponse(T data, PageInfo pageInfo) {
        this.data = data;
